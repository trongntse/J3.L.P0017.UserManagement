            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="dto" items="${sessionScope.LIST_USER}" >         
                        <form action="UpdateController">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img  src="./images/${dto.photo}" alt="${dto.photo}" width="80px" height="70px" />
                                ...
                                <td>
                                    <c:url 
                                        var="urlAdd" value="AddToPromotionController">
                                        <c:param name="txtUserID" value="${dto.userID}"/>
                                        <c:param name="txtUserName" value="${dto.userName}"/>
                                    </c:url>
                                    <c:choose>
                                        <c:when test="${dto.roleID eq 'AD'}">

                                        </c:when>
                                        <c:when test="${dto.roleID eq 'US'}">
                                            <script type="text/javascript">
                                                function Alert() {
                                                    alert("Add Success");
                                                }
                                            </script>
                                            <a href="${urlAdd}" onclick=" Alert()" class="delete" title="Add" data-toggle="tooltip"><i class="far fa-calendar-plus"></i></a>                                           
                                        </c:when>
