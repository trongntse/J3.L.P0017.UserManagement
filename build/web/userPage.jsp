<%-- 
    Document   : userPage
    Created on : Jun 17, 2021, 6:30:25 PM
    Author     : user
--%>
        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-9">		                           
                            <h2> <b>Wellcom User: ${LOGIN_USER.userName}</b></h2>
                            <style>
                                #link { color: #FF0000; } 
                            </style>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>                  
                        <c:set scope="request" var="dto" value="${sessionScope.USER}" />
                    <form action="UserUpdateController">
                        <tr>
                            ...
                            <td>
                                <input class="form-control" style="width: 70px" type="password" name="txtPassword" value="${dto.password}"/>                                  
                            </td>
                            ...
                            <td>
                                <c:url 
                                    var="urlDelete" value="UserDeleteController">
