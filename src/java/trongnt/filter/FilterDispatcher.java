...
public class FilterDispatcher implements Filter {
    ...
    public FilterDispatcher() {
        ...
        USER.add("LoadUserController");
        USER.add("UserDeleteController");
        USER.add("UserUpdateController");
       
        ADMIN = new ArrayList<>();
        ADMIN.add("adminPage.jsp");
        ADMIN.add("createPage.jsp");
        ADMIN.add("promotionList.jsp");
        ADMIN.add("history.jsp");
        ADMIN.add("CreateUserController");
        ADMIN.add("DeleteController");
        ADMIN.add("UpdateController");
        ADMIN.add("LoadAdminController");
        ADMIN.add("LoadAllUserController");
        ADMIN.add("LoadSubController");
        ADMIN.add("SearchController");
        ADMIN.add("AddToPromotionController");
        ADMIN.add("DeleteCartController");
        ADMIN.add("UpdateCartController");       
        ADMIN.add("SaveController");
        ADMIN.add("SaveListController");
        ADMIN.add("HistoryController");
